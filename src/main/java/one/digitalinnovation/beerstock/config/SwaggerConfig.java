...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Mariani Fracon";
    private static final String CONTACT_GITHUB = "https://gtihub.com/MarianiFracon";
    private static final String CONTACT_EMAIL = "marianifracon@gmail.com";
